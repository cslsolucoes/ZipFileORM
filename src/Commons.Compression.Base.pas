{*
 * Commons.Compression.Base.pas
 *
 * Classe base abstrata + factory pattern para compressão genérica.
 * Era tiCompress.pas do MCL — renomeado para namespace Commons.* na v4.0.0.
 *
...
type
  ...
  // Class to hold TtiCompress class mappings — factory uses CompressClass to instantiate
  ...
  // Factory pattern — creates TtiCompress descendants at runtime
...
// Single instance of TtiCompressFactory (singleton)
var
