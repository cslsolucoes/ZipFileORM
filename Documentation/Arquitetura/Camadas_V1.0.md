...
|---|---|---|
| `TZipFile` | `ZipFile.pas` | ZipCompress |
| `TTarFile` | `TarFile.pas` | ZipCompress |
| `TTarGzFile` | `TarGzFile.pas` | ZipCompress |
| `TGzipFile` | `GzipFile.pas` | ZipCompress |
| `TCabFile` | `CabFile.pas` | ZipCompress |
| `TSevenZFile` | `SevenZFile.pas` | ZipCompress |
| `TArjFile` | `ArjFile.pas` | ZipCompress |
| `TIsoFile` | `IsoFile.pas` | ZipCompress |
| `TLhaFile` | `LhaFile.pas` | ZipCompress |
| `TRarFile` | `RarFile.pas` | ZipCompress |
