 ...
 *
 *      Copyright (c) 1987, 2026 by Embarcadero Technologies, Inc.
 *      All Rights Reserved.
 *
 */
...
#if defined (_INTEGRAL_MAX_BITS) && (_INTEGRAL_MAX_BITS >= 64) && !defined(__STDC__)
intptr_t _RTLENTRY _EXPFUNC _wfindfirsti64(const wchar_t *__filespec, struct _wfinddatai64_t *__fileinfo);
int      _RTLENTRY _EXPFUNC _wfindnexti64(intptr_t __handle, struct _wfinddatai64_t *__fileinfo);
intptr_t _RTLENTRY _EXPFUNC _findfirsti64(const char *__filespec, struct _finddatai64_t *__fileinfo);
int      _RTLENTRY _EXPFUNC _findnexti64(intptr_t __handle, struct _finddatai64_t *__fileinfo);
#endif /* _INTEGRAL_MAX_BITS */

intptr_t _RTLENTRY _EXPFUNC __wfindfirst(const wchar_t *__filespec, struct _wfinddata_t *__fileinfo);
int      _RTLENTRY _EXPFUNC __wfindnext(intptr_t __handle, struct _wfinddata_t *__fileinfo);
intptr_t _RTLENTRY _EXPFUNC _findfirst(const char *__filespec, struct _finddata_t *__fileinfo);
int      _RTLENTRY _EXPFUNC _findnext(intptr_t __handle, struct _finddata_t *__fileinfo);
int      _RTLENTRY _EXPFUNC _findclose(intptr_t __handle);
