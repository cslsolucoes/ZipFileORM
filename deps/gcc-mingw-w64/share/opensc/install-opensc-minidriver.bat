...
SET ATR_MASK[%COUNT%]=ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff
SET /A COUNT+=1
SET  SC_NAME[%COUNT%]=CardOS v6.0
SET      ATR[%COUNT%]=3b,d2,18,00,81,31,fe,58,cb,01,16
SET ATR_MASK[%COUNT%]=ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff
SET /A COUNT+=1
...
SET /A COUNT+=1
SET  SC_NAME[%COUNT%]=nqApplet JCOP4
SET      ATR[%COUNT%]=3b,d5,18,ff,81,91,fe,1f,c3,80,73,c8,21,10,0a
SET ATR_MASK[%COUNT%]=ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff
SET /A COUNT+=1
SET  SC_NAME[%COUNT%]=nqApplet JCOP4.52
SET      ATR[%COUNT%]=3b,d8,18,ff,81,b1,fe,45,1f,c3,80,73,c8,21,10,52,b7,7f,f8
SET ATR_MASK[%COUNT%]=ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff,ff
SET /A COUNT+=1
SET  SC_NAME[%COUNT%]=nqApplet JCOP4 RFID
SET      ATR[%COUNT%]=3b,85,80,01,80,73,c8,21,10,0e
SET ATR_MASK[%COUNT%]=ff,ff,ff,ff,ff,ff,ff,ff,ff,ff
