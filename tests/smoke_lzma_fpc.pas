{ smoke_lzma_fpc.pas â€” FPC-compatible LZMA round-trip smoke }
program smoke_lzma_fpc;
{$IFDEF FPC}{$mode delphi}{$H+}{$ENDIF}
uses
  SysUtils, Commons.Compression.LZMA;
var
...
begin
  try
    ...
    for I := 0 to High(Plain) do Plain[I] := Byte(I mod 23);
