# APPNOTE — PKWARE .ZIP File Format Specification (v6.3.0)

> Documento de referência **PKWARE oficial** preservado integralmente.
> Conteúdo abaixo é o texto bruto da APPNOTE.TXT vendor (Sep 29, 2006);
> formatação ASCII original mantida em bloco code-fenced para preservar
> alinhamento de tabelas de bytes e layouts binários — qualquer
> reformatação Markdown quebraria os offsets descritos.
>
> **Versão:** 6.3.0
> **Data:** September 29, 2006
> **Copyright:** (c) 1989-2006 PKWARE Inc., All Rights Reserved.
> **Site oficial:** <https://pkware.com/appnote>
> **Contato vendor:** <zipformat@pkware.com>
>
> Esta referência é usada pelo ZipFileORM.pas (TZipFile) e helpers
> em src/ZipFileORM.{ZIP64,UTF8,Encryption.AES,...}.pas como autoridade
> para semântica do formato. Versões mais recentes (6.3.1 .. 6.3.10)
> introduziram ZIP64 expansions + AES-256 (já implementados via
> WinZip-AE-2 spec separada, ver src/ZipFileORM.Encryption.AES.pas).
